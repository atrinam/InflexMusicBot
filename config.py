...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", -1002439871631))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/TM_KARTAL")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/linkdonitehranasl")
